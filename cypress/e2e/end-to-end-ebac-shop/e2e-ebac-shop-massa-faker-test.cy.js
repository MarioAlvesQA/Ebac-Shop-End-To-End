...
describe('Exercicio - Testes End-to-end - Fluxo de pedido', () => {
    ...
    context('Exercicio - Testes End-to-end - Fluxo de pedido válido', () => {
      ...
      it('Deve fazer um pedido na loja Ebac Shop de ponta a ponta - Usando dados aleatórios e novo usuário por execução', () => {
          ...
          // Abaixo é possivel utilizar dados Faker Koreano, Francês, Brasileiro e Norte Americano
          let emailFaker = fakerBR.internet.email();
          let passwordFaker = faker.internet.password();
          let firstNameFaker = fakerBR.person.firstName();
          let lastNameFaker = fakerBR.person.lastName(); 
          ...
          cy.fixture('product-list').then(product1 => {
            ...
            productsPage.goToCart(); // seguir para o carrinho
            ...
            cy.screenshot('carrinho-completo-antes-checkout'); // Screenshot do carrinho antes de prosseguir para checkout

            productsPage.checkOut(); // seguir para o checkout
            ...
            billDetailsMethodBR();
            cy.screenshot('detalhes-do-faturamento-preenchido')
            ...
            cy.screenshot('pedido-concluido-sucesso')
            ...
            cy.screenshot('validar-pedido-minha-conta')
